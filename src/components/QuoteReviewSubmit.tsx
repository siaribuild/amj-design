  ...
  return (
    <div className="quote-page min-h-screen ground-bone pt-16">
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        <div className="quote-notice--info border border-line p-4 mb-6 text-xs text-body"><AlertCircle className="w-3 h-3 inline mr-1" />Estimated totals are confirmed on technical review. No deposit until you approve the reviewed quote. Supply only — installation not included.</div>
