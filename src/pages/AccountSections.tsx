    ...
    <>
      ...
      <div className="grid sm:grid-cols-2 gap-4 max-w-3xl">
        <div className="card p-5">
          <h3 className="text-[13px] uppercase tracking-[0.1em] text-body font-medium mb-3.5" style={{ fontFamily: "'DM Mono', monospace" }}>Talk to us</h3>
        ...
        <div className="card p-5">
          <h3 className="text-[13px] uppercase tracking-[0.1em] text-body font-medium mb-3.5" style={{ fontFamily: "'DM Mono', monospace" }}>Send a message</h3>
        ...
        <div className="card p-5 sm:col-span-2">
          <h3 className="text-[13px] uppercase tracking-[0.1em] text-body font-medium mb-3.5" style={{ fontFamily: "'DM Mono', monospace" }}>Guides</h3>
